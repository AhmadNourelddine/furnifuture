...
const CreateShippingProfile = () => {
  ...
  return (
    <Box
      style={{ backgroundColor: "#ECDCCF", height: "100%", minHeight: "100vh" }}
    >
      ...
      >
          ...
          <Box className="createdelivery-input">
            ...
            <Box className="createdelivery-input-section">
              <TextField
                ...
                className="createdelivery-input-textfield"
              ></TextField>
            </Box>
          </Box>
          <Box className="createdelivery-input">
        ...
        <Box style={{ display: "felx", flexDirection: "column" }}>
          <Box className="createdelivery-input">
            ...
            <Box className="createdelivery-input-section">
              <Autocomplete
                className="createdelivery-autocomplete-section"
                disablePortal
                options={locations}
                value={location}
                sx={{ width: 300 }}
          ...
          <Box
            ...
            className="deliveryprofile-cancel-create-btns"
          >
            <Button
              onClick={() => {
                Navigate("/about");
